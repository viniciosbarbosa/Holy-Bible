      ...
      {Object.entries(groupedVerses).map(([key, group]) => (
        <section key={key} className="space-y-6">
          <div className="flex items-center gap-4 px-2">
            <div className="h-px flex-1 bg-gradient-to-r from-transparent via-bible-gold/20 to-transparent" />
            <div className="flex flex-col items-center">
              <h2 className="font-cinzel text-sm text-bible-gold tracking-[0.3em] uppercase">
                {group.title}
              </h2>
              <span className="text-[8px] font-cinzel text-bible-muted uppercase tracking-widest opacity-60">
